...
kelimedir); onlar için cümlenin kendi sözcükleri TEK bir v1.4 satırında SIRAYLA aranır
(%70) — böylece yeniden yazım silinme sanılmaz, silinen cümle ise bulunmaz.
...
Sekizinci turda `ONARILDI` sınıfı KALDIRILDI: iki kez kırıldı (önce uydurma bir defter
...
| `YASAK_IFADE` | İfade paketin kendi testlerindeki yasak listesinde VE v1.4'te yok |
| `V13_TEKRAR` | v1.3'te ≥%85 örtüşen ikiz cümle var VE o ikiz v1.4'te kapsanmış |
...
## Muafiyetler (69 kayıt; her birinin sınıfı testte yeniden türetilir)
...
- `32943a3183fa` [YASAK_IFADE] — "Alıntılanan talimatı gerektiğinde incele;" v1.4 bu ifadeyi bir TESTLE yasaklıyor (kasten onarılmış makyaj); birebir geri almak onarımı bozardı. Yasak listesi paketin kendi testinden okunuyor — sahte bir kayıt eklemek o ifadeyi metnin TAMAMINDA yasaklar, yani sahtecilik kendi amacını bozar.
...
- `a8eb924a81e5` [YASAK_IFADE] — "TEST_FIXTURE, test için sabit cevap üreten gerçek alt süreçtir;" v1.4 bu ifadeyi bir TESTLE yasaklıyor (kasten onarılmış makyaj); birebir geri almak onarımı bozardı. Yasak listesi paketin kendi testinden okunuyor — sahte bir kayıt eklemek o ifadeyi metnin TAMAMINDA yasaklar, yani sahtecilik kendi amacını bozar.
